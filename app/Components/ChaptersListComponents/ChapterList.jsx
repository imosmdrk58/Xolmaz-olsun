                    ...
                    <div className="flex flex-col bg-gray-800/50 md:flex-row justify-between items-center gap-6  rounded-lg p-2 pl-6  shadow-lg border border-purple-500/10">
                        ...
                        <div className="flex items-center gap-6 bg-gray-800/50 rounded-md px-5 py-3 shadow-md border border-gray-700/30">
                            <div className="text-center">
                                <span className="block text-sm text-gray-400 font-medium">Available</span>
                                <span className="text-xl font-semibold text-white">{groupedChapters.length}</span>
                            </div>
                            <div className="w-px h-8 bg-purple-500/50"></div>
                            <div className="text-center">
                                <span className="block text-sm text-gray-400 font-medium">Total</span>
                                <span className="text-xl font-semibold text-yellow-500">{groupedChapters.length}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                transition-all duration-200 hover:border-purple-500 hover:bg-gray-750 
                 overflow-hidden`}
                            >
                                ...
                                >
                                    <div className={`
                                absolute top-0 left-0 my-2 rounded-full h-[85%] w-1 
                                ${activeChapter === groupedChapter.chapter ? 'bg-purple-400' : 'bg-gray-700'}
                            `}></div>
                                    ...
                                    `}>
                                            ...
                                            <div>
                                                ...
                                                <div className="flex items-center gap-2 text-sm">
                                                    <span className="text-gray-400">{groupedChapter.translations.length} Translations</span>
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="hidden md:flex items-center">
                                                ...
                                                {groupedChapter.translations.length > 3 && (
                                                    <span className="text-xs text-gray-400 ml-2">+{groupedChapter.translations.length - 3}</span>
                                                )}
                                            </div>
                                        ...
                                        ${activeChapter === groupedChapter.chapter ? 'bg-purple-900' : 'bg-gray-700'}
                                    `}>
                                                <Image
                                                    src={activeChapter === groupedChapter.chapter ? "/vertical.svg" : "/horizontal.svg"}
                                                    alt="Toggle"
                                                    width={16}
                                                    height={16}
                                ...
                                {/* Translations Panel */}
                                {activeChapter === groupedChapter.chapter && (
                                    <div className="border-t border-gray-800 p-4 rounded-lg" style={{ background: 'rgba(18, 18, 18, 0.2)' }}>
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div>
                                                            <div className="text-white font-semibold">
                                                                {langFullNames[translation.translatedLanguage] || translation.translatedLanguage}
                                                            </div>
                                                            <div className="flex items-center text-xs gap-2">
                                                                <span className="text-gray-400">
                                                                    {translation.pageCount ? `${translation.pageCount} pages` : 'Pages unknown'}
                                                                </span>
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        <div className="w-8 h-8 rounded-full flex items-center justify-center bg-gray-900/50 transform groupedChapter-hover:scale-110 transition-transform">
                                                            <Image src="/views.svg" alt="Read" width={16} height={16} className="text-white" />
                                                        </div>
                                                    </div>
                                                </div>
                                            ))}
                                ...
                                {/* Hover Indicator */}
                                <div className="absolute bottom-0 left-0 w-full h-1 bg-purple-900 transform scale-x-0 
                  groupedChapter-hover:scale-x-100 transition-transform duration-200 origin-left"
                                />
                            </div>
                        </div>
                    ))}
