    ...
    <div className="relative font-sans" ref={dropdownRef}>
      ...
      >
        <span className="flex items-center gap-2 sm:gap-2.5">
          <LayoutIcon
            className="w-4 sm:w-5 h-4 sm:h-5 border border-white text-white rounded-md bg-violet-500/20 p-0.5"
            aria-hidden="true"
          />
...
const PageLoadingOption = React.memo(({ Icon, label, value, currentLayout, onSelect }) => {
  ...
  return (
    ...
    >
      <Icon
        className="w-4 sm:w-5 h-4 sm:h-5 mr-2 sm:mr-2.5 border border-white text-white rounded-md bg-violet-500/20 p-0.5"
        aria-hidden="true"
      />
