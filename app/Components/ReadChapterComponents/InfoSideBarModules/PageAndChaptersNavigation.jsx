...
const PageNavigation = memo(({ currentIndex, chapterInfo, goToPrevPage, goToNextPage }) => (
  <div
    className="tracking-wider flex items-center gap-1.5"
    role="navigation"
    aria-label="Page navigation"
  >
    <button
      className={`p-1.5 tracking-wider rounded-md ${
        currentIndex >= 1
    ...
    return (
      <div className="tracking-wider bg-gray-900/50 border-t border-purple-700/20 p-3">
        ...
        <div className="tracking-wider relative" ref={dropdownRef}>
          ...
          >
            <span className="tracking-wider font-medium truncate">
              ...
              <div className="tracking-wider py-1">
                {filteredChapters.map((chapter) => (
                  <button
                    ...
                    className={`w-full tracking-wider text-left px-3 py-2 text-sm hover:bg-purple-900/30 ${
        ...
        <div className="tracking-wider mt-3 grid grid-cols-2 gap-2">
          <button
            ...
            className={`flex tracking-wider gap-3 items-center justify-center py-2 rounded-lg ${
              hasPrevChapter
          ...
          <button
            ...
            className={`flex items-center gap-3 justify-center py-2 rounded-lg ${
              hasNextChapter
                ? 'bg-purple-900/30 text-white border border-purple-700/20 hover:bg-purple-800/40'
                : 'bg-gray-800/30 text-gray-500 border border-gray-700/20 cursor-not-allowed'
            }`}
