...
const PageNavigation = memo(({ currentIndex, chapterInfo, goToPrevPage, goToNextPage, PrevIcon, NextIcon }) => (
  <div className="tracking-wider flex items-center gap-1.5" role="navigation" aria-label="Page navigation">
    <button
      className={`p-1.5 tracking-wider rounded-md ${currentIndex >= 1 ? 'bg-purple-900/30 hover:bg-purple-800/40 text-white' : 'bg-gray-800/30 text-gray-500 cursor-not-allowed'}`}
    ...
    <button
      className={`p-1.5 tracking-wider rounded-md ${currentIndex < chapterInfo.pageCount ? 'bg-purple-900/30 hover:bg-purple-800/40 text-white' : 'bg-gray-800/30 text-gray-500 cursor-not-allowed'}`}
...
const PageAndChaptersNavigation = memo(({
  ...
  return (
    <div className="tracking-wider bg-gray-900/50 border-t border-purple-700/20 p-3">
      ...
      <div className="tracking-wider relative" ref={dropdownRef}>
        <button
          ...
          className="tracking-wider w-full flex items-center justify-between bg-gray-800/50 border border-purple-700/20 rounded-lg px-3 py-2 text-white hover:bg-purple-900/30 transition-colors duration-300"
        ...
        {chapterDropdownOpen && (
          <div
            ...
            className="tracking-wider absolute p-3 pt-0 top-full left-0 w-full mt-1 max-h-56 overflow-y-auto bg-gray-900/95 backdrop-blur-lg border border-purple-700/30 rounded-lg shadow-2xl z-50"
          >
            <div className="tracking-wider sticky pt-5 top-0 bg-gray-900/95 p-2 border-b border-purple-700/30">
      ...
      <div className="tracking-wider mt-3 grid grid-cols-2 gap-2">
        <button
      ...
      <div className="tracking-wider mt-3">
        <div className="tracking-wider text-xs text-gray-400 mb-1">Reading Progress</div>
