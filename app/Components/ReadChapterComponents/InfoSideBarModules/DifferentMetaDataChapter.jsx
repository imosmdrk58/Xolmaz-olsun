          ...
          <>
            <div className="tracking-wider bg-gray-800/50 rounded-lg border border-purple-700/20 p-3">
              ...
              >
                ...
                <ChevronDown className={`w-4 tracking-wider h-4 ${collapsedSections.description ? 'rotate-180' : ''}`} />
              </button>
            ...
            <div className="tracking-wider bg-gray-800/50 rounded-lg border border-purple-700/20 p-3">
              ...
              >
                ...
                <ChevronDown className={`w-4 tracking-wider h-4 ${collapsedSections.creators ? 'rotate-180' : ''}`} />
              </button>
            ...
            <div className="tracking-wider bg-gray-800/50 rounded-lg border border-purple-700/20 p-3">
              ...
              >
                ...
                <ChevronDown className={`w-4 tracking-wider h-4 ${collapsedSections.publication ? 'rotate-180' : ''}`} />
              </button>
            ...
            <div className="tracking-wider bg-gray-800/50 rounded-lg border border-purple-700/20 p-3">
              ...
              >
                ...
                <ChevronDown className={`w-4 tracking-wider h-4 ${collapsedSections.languages ? 'rotate-180' : ''}`} />
              </button>
