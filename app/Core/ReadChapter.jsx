      ...
      <div className="flex flex-row w-full justify-between items-start h-full -mt-5 bg-[#070920] backdrop-blur-md text-white">
                ...
                <div key={index} className="relative h-[75vh] flex justify-center items-center">
                  ...
                  <div className="fixed flex flex-col justify-end items-end bottom-28 right-4">
                    {!isLoadingOCR ? (<>
                      ...
                      <MemoizedTextToSpeech page={page} handleUpload={handleUpload} ready={Boolean(pageTTS[page] ? isItTextToSpeech : pageTranslations[page])} text={isItTextToSpeech ? textResult : translatedText} />
                    </>) : (
                    ...
                    <div className="absolute top-1/2 transform space-y-4 -translate-y-1/2 flex flex-col justify-end items-end bottom-28 right-3">
                      ...
                      >
                        ...
                        {pageTranslations[page] ? "Translated" : "Translate"}
                          ...
                          <MemoizedTextToSpeech page={page} handleUpload={handleUpload} ready={Boolean(pageTTS[page] ? isItTextToSpeech : pageTranslations[page])} text={isItTextToSpeech ? textResult : translatedText} layout={layout}/>
        ...
        {showMessage && layout!=="vertical" && (
          <div className="absolute z-50 text-wrap w-fit max-w-72 top-12 border-purple-500 border right-4 bg-gray-800 text-white p-4 rounded-lg shadow-lg transition-opacity duration-300">
            ...
            <p>{isItTextToSpeech ? textResult : translatedText || "No text Available"}</p>
          </div>
        )}
      </div>
    ) : (
